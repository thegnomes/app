  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-end pb-10 md:pb-16 px-6 md:px-10 overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <h1 className="mb-8 text-[3rem] font-medium tracking-tight leading-[0.95] text-white md:text-[4.5rem] lg:text-[6rem]">
          Sonic
          <br />
          <span className="portfolio-template-serif italic">Identity</span>
        </h1>

        <p className="mb-10 max-w-xl text-[1rem] leading-relaxed text-neutral-300 md:text-[1.125rem]">
    ...
    <section id="overview" className="px-6 md:px-10 py-2 md:py-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
        ...
        <div className="md:col-span-8">
          <FadeIn delay={100}>
            <p className="mb-8 text-[1.5rem] font-medium leading-snug text-neutral-100 md:text-[1.875rem] lg:text-[2.25rem]">
              At MORAE, we don’t follow trends. We study the subtle patterns of sound and the ways people interact with it.
            </p>
          </FadeIn>
          <FadeIn delay={200}>
            <p className="max-w-2xl text-[1rem] leading-relaxed text-neutral-400 md:text-[1.125rem]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
        {STATS.map((s, i) => (
          <FadeIn key={s.num} delay={i * 100}>
            <p className="portfolio-template-counter mb-6 text-[0.875rem] text-neutral-600">
              {s.num}
            </p>
            <h3 className="mb-2 text-[1.5rem] font-medium text-neutral-100 md:text-[1.875rem]">{s.title}</h3>
            <p className="mb-3 text-[0.875rem] font-medium text-neutral-300">{s.desc}</p>
            <p className="text-[0.875rem] leading-relaxed text-neutral-500">{s.detail}</p>
          </FadeIn>
        ))}
      </div>
    </section>
  ...
  return (
    <section className="px-6 md:px-10 py-24 md:py-40">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <FadeIn delay={150}>
          <h2 className="portfolio-template-serif text-[1.875rem] font-normal leading-tight text-neutral-100 md:text-[3rem] lg:text-[3.75rem]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
        {items.map((item) => (
          <div key={item.label}>
            ...
            <FadeIn delay={100}>
              <h3 className="mb-6 text-[1.5rem] font-medium text-neutral-100 md:text-[1.875rem]">{item.heading}</h3>
            </FadeIn>
            <FadeIn delay={200}>
        ...
        <FadeIn>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10 mb-16">
            <div>
              ...
              <a
                href="/portfolio.html"
                className="text-[1.875rem] font-medium text-neutral-100 transition-colors hover:text-neutral-400 md:text-[3rem]"
              >
